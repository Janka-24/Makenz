...
export default function Footer() {
    ...
    return (
        <footer className="flex flex-col lg:flex-row border-t-2 border-white items-center justify-between w-[90%] mx-auto h-auto lg:h-[30vh] text-green-600">
            ...
            <div className='w-full lg:w-2/6 h-full flex justify-center gap-5 items-start p-5 flex-col mt-5'>
                ...
                <div className='flex flex-col items-start justify-evenly w-full h-full gap-2'>
                    ...
                    <a href="#" className='text-sm text-white'>Réservation</a>
